...
import com.sean.ebusiness.repository.admin.GoodsRepository;
...
public class GoodsServiceImpl implements GoodsService{
	...
	public String addGoods(Goods goods, HttpServletRequest  request, String act) throws IllegalStateException, IOException {
		...
		if(!myfile.isEmpty()) {
			...
			//获得上传文件原名
			//上传文件路径（开发环境），改为自己的项目文件夹位置
			String path = "F:\\IDEA_Projects\\eBusiness\\src\\main\\resources\\static\\images";
			//获得上传文件原名
